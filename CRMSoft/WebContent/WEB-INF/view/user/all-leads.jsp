        ...
        <!-- /row -->     
                <form:form action="#">                  
                   Go to : <select name="foo" id="foo" value="${myBean.foo}">
					    ...
					    <core:forEach var="sleaduser" items="${smartleads}">					      
					        <option value="${sleaduser.leadType}"><core:out value="${sleaduser.leadName}" ></core:out></option>
					    </core:forEach>                
				  </select>  				                 
               </form:form> 
               <br/>
                                ...
                                <div class="col-lg-6">                                   
                                   <div id="sPhoneFromResponse"></div>
	                                   <table  cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-striped">
										...
										<tbody>
										<core:forEach var="sPhone" items="${smartleads}">
										<tr>
										<td>${sPhone.leadType}</td>
										<td>${sPhone.leadName}</td>
										<td>${sPhone.leadDate}</td>
										<td>
										<a href="${pageContext.request.contextPath}/forms/user/leadedit/${sPhone.id}.json">Edit</a> | <a href="${pageContext.request.contextPath}/forms/user/leaddelete/${sPhone.id}.json">Delete</a><br/>
										</td>
										</tr>
										</core:forEach>
										</tbody>
										</table>								
								   <a href="${pageContext.request.contextPath}/forms/user/crmpanel.html">Home page</a>
                                </div>
                            </div>
                        </div> 
                     </div>
